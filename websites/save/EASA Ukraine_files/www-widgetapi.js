...
m.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Mb(a.src):"https://web.archive.org/web/20220320041608/https://www.youtube.com"),this.i=new nn(b),c||(b=wn(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.h=a,this.h.id||(this.h.id="widget"+Oa(this.h)),gn[this.h.id]=this,window.postMessage){this.l=new L;xn(this);b=on(this.i,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in jn)jn.hasOwnProperty(e)&&
un(this,e)}};
...
/*
     FILE ARCHIVED ON 04:16:08 Mar 20, 2022 AND RETRIEVED FROM THE
...
playback timings (ms):
  ...
  cdx.remote: 0.085
  esindex: 0.009
  LoadShardBlock: 128.036 (6)
  PetaboxLoader3.datanode: 151.45 (8)
  load_resource: 128.087 (2)
  PetaboxLoader3.resolve: 69.833 (2)
*/